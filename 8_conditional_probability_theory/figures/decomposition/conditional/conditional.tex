...
\begin{tikzpicture}[scale=1, thick]
  ...
  \begin{scope}[shift={(0, 0)}]
    \draw[white] (-4.75, -3) rectangle (4.25, 4.5);
    ...
    \pgfmathsetmacro{\dy}{0.25}
    \pgfmathsetmacro{\tilt}{0.3 * \dy / \dx}
    \foreach \x/\y/\p\glyph [count=\n] in {-2/1.65/0.1/\clubsuit, 0/1.35/0.1/\triangle} {
      \begin{scope}[shift={(\x, \y)}]
        \drawcube{\dx}{\dy}{4 * (1/0.2) * \p}{\tilt}
        \node[white] at (0, {4 * (1/0.2) * \p}) { $\glyph$ };
      \end{scope}
    }
    
    \pgfmathsetmacro{\y}{+1.5}
    \pgfmathsetmacro{\x}{-1.25 * \Dx - 0.3 * \y}
    \node[dark] at (\x, \y) { $\pi^{f}_{\heartsuit}$ };
  \end{scope} 
  ...
  \begin{scope}[shift={(9, 0)}]
    ...
    \pgfmathsetmacro{\dy}{0.25}
    \pgfmathsetmacro{\tilt}{0.3 * \dy / \dx}
    \foreach \x/\y/\p\glyph [count=\n] in {0/-0.4/0.2/\blacksquare,  2/-0.15/0.4/\diamondsuit, -2/-0.25/0.15/\bowtie} {
      \begin{scope}[shift={(\x, \y)}]
    ...
    \pgfmathsetmacro{\x}{-1.25 * \Dx - 0.3 * \y}
    \node[dark] at (\x, \y) { $\pi^{f}_{\spadesuit}$ };
  \end{scope} 
  ...
  \begin{scope}[shift={(18, 0)}]
    ...
    \pgfmathsetmacro{\y}{-1.5}
    \pgfmathsetmacro{\x}{-1.25 * \Dx - 0.3 * \y}
    \node[dark] at (\x, \y) { $\pi^{f}_{\bigstar}$ };
  \end{scope} 
