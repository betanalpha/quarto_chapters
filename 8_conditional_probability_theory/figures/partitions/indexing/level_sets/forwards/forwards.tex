...
\begin{tikzpicture}[scale=1]
  ...
  \node[darkteal] at (1, 3.5) { $\mathsf{c}_{1}$ };

  \filldraw[draw=darkteal, fill=midteal, opacity=0.5, line width=1]
    (0, 2) -- (6, 2) -- (6, 3) -- (0, 3) -- cycle;
  \node[darkteal] at (1, 2.5) { $\mathsf{c}_{2}$ };
    
  \filldraw[draw=darkteal, fill=midteal, opacity=0.5, line width=1]
    (0, 1) -- (6, 1) -- (6, 2) -- (0, 2) -- cycle;
  \node[darkteal] at (1, 1.5) { $\mathsf{c}_{3}$ };
        
  \filldraw[draw=darkteal, fill=midteal, opacity=0.5, line width=1]
    (0, 1) -- (6, 1) {[rounded corners=5] -- (6, 0) -- (0, 0)} -- cycle;
  \node[darkteal] at (1, 0.5) { $\mathsf{c}_{4}$ };

  \foreach \i in {1, 2, 3, 4} {
    \draw[darkteal, line width=1] (7, 3.5 + 1 - \i) circle (0.2);
    \node[darkteal] at (7, 3.5 + 1 - \i) { $\i$ };
  }
  \node at (7, -0.5) { $\{1, 2, 3, 4\}$ };
  
  
  \foreach \x/\y/\i in {2/3.75/1, 4/3.15/1, 3/2.8/2, 5/1.9/3, 2.5/1.6/3, 5.5/1.1/3, 3.5/0.3/4} {
    \draw[->, -{Stealth[length=4pt, width=4pt]}, shorten >=6, darkteal, line width=1] (\x, \y) -- (7, 3.5 + 1 - \i);
    \fill[darkteal] (\x, \y) circle (0.075);
  }
