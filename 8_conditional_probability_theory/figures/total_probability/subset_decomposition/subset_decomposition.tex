...
\begin{tikzpicture}[scale=1]
  ...
  \node[dark] at (3, 5.0) { $\mathsf{x} = \quad (\mathsf{x} \cap \mathsf{c}_{1}) \cup (\mathsf{x} \cap \mathsf{c}_{2})$ };
  \node[dark] at (3, 4.5) { $\hphantom{\mathsf{x} = } \cup (\mathsf{x} \cap \mathsf{c}_{3}) \cup (\mathsf{x} \cap \mathsf{c}_{4})$ };
  ...
  \node[dark] at (4, 3.35) { $\mathsf{x} \cap \mathsf{c}_{1}$ };
  
  \draw[dark, line width=1] (2.425, 2.97) -- (5.46, 2.97);
  \draw[dark, line width=1] (2.475, 2.03) -- (5.333, 2.03);
  \node[dark] at (4, 2.5) { $\mathsf{x} \cap \mathsf{c}_{2}$ };

  \draw[dark, line width=1] (2.497, 1.97) -- (5.31, 1.97);
  \node[dark] at (4, 1.5) { $\mathsf{x} \cap \mathsf{c}_{3}$ };

  \node[dark] at (4.3, 0.5) { $\mathsf{x} \cap \mathsf{c}_{4} =  \emptyset$ };
