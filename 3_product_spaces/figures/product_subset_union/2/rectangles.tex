...
\begin{tikzpicture}[scale=1.0]
  ...
  \node[darkteal] at (0, 2.35) { 
    $( \mathsf{I}_{11} \times \mathsf{I}_{12} ) \cup ( \mathsf{I}_{21} \times \mathsf{I}_{22} )$ 
  };
  ...
  \draw[midteal, dashed, line width=1] (\xa, \ya) rectangle (\xb, \yb);
  \draw[lightteal, dashed, line width=1] (\Xa, \Ya) rectangle (\Xb, \Yb);
  
  %\node[white, midway] { $\mathsf{I}_{21} \times \mathsf{I}_{22}$ };
