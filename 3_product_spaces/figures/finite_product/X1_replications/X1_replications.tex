...
\begin{tikzpicture}[scale=1, thick]
  ...
  \begin{scope}[shift={(10.25, 0)}]
    ...
    \begin{scope}[shift={(-2 - \tilt * 0.75, 0.15 + 0.75)}]
      \node[midteal] at (0, 0) { $(\Box, \heartsuit)$ };
    ...
    \begin{scope}[shift={(+2 - \tilt * 0.75, +0.05 + 0.75)}]
      \node[midteal] at (0, 0) { $(\diamondsuit, \heartsuit)$ };
      \draw[midteal]    ({-(1 - \tilt * \dy / \dx) * \dx}, -\dy) 
                   -- (+{(1 + \tilt * \dy / \dx) * \dx}, -\dy) 
                   -- ({+(1 - \tilt * \dy / \dx) * \dx}, +\dy) 
                   -- ({-(1 + \tilt * \dy / \dx) * \dx}, +\dy) -- cycle;
    ...
    \begin{scope}[shift={(-2 + \tilt * 0.75, 0.15 - 0.75)}]
      \node[darkteal] at (0, 0) { $(\Box, \spadesuit)$ };
    ...
    \begin{scope}[shift={(+0 + \tilt * 0.75, -0.15 - 0.75)}]
      \node[darkteal] at (0, 0) { $(\clubsuit, \spadesuit)$ };
      \draw[darkteal]    ({-(1 - \tilt * \dy / \dx) * \dx}, -\dy) 
                   -- (+{(1 + \tilt * \dy / \dx) * \dx}, -\dy) 
                   -- ({+(1 - \tilt * \dy / \dx) * \dx}, +\dy) 
                   -- ({-(1 + \tilt * \dy / \dx) * \dx}, +\dy) -- cycle;
    ...
    \node[midteal] at (4.389, 0.7615) { $\heartsuit$ };
    
    \node[black] at (+\tilt * 0.75 + 4.25, -0.75) { $ X_{1} \times \{ \spadesuit \}$ };
    \node[darkteal] at (4.989, -0.7381) { $\spadesuit$ };
  \end{scope}
