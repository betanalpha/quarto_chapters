...
\begin{tikzpicture}[scale=1.0]
  ...
  \fill[midteal] (-3, -1.5) rectangle (3, -1) 
  node[white, midway] { $\mathsf{x}_{1}$ };
  \draw[midteal, densely dotted, line width=1.5] (-3, -1.5) -- (-3, -1);
  \draw[midteal, densely dotted, line width=1.5] (+3, -1.5) -- (+3, -1);
    
  \fill[darkteal] (-1.8, -2) rectangle (-0.75, 2) 
  node[white, midway] { $\mathsf{x}_{2}$ };
  \draw[darkteal, densely dotted, line width=1.5] (-1.8, -2) -- (-0.75, -2);
  \draw[darkteal, densely dotted, line width=1.5] (-1.8, +2) -- (-0.75, +2);
