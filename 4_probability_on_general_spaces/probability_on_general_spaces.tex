...
from these interval allocations using a powerful technical method known
as \textbf{Carathéodory's extension theorem} (Folland (1999)). The
resulting uniform measure is known as the \textbf{Lebesgue measure}.
...
there are also some subtle mathematical complications with this approach
(Wrinch and Jeffreys (1919)). For a comprehensive discussion see
...
\bibitem[\citeproctext]{ref-WrinchEtAl:1919}
Wrinch, Dorothy, and Harold Jeffreys. 1919. {``LXXV. On Some Aspects of
the Theory of Probability.''} \emph{The London, Edinburgh, and Dublin
Philosophical Magazine and Journal of Science} 38 (228): 715--31.
