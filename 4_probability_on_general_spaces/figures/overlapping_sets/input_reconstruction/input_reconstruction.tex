...
\begin{tikzpicture}[scale=1.0]
  ...
  \begin{scope}[shift={(0, 0)}]
    \draw[white] (-3.5, -3) rectangle (3.5, 3);
  
    \draw[rounded corners=3, color=black, line width=1] (-3, -2) rectangle (3, 2);
    \node at (0, -2.5) { $X$ };
      
    \fill[darkteal] plot [smooth cycle, tension=0.75] coordinates { 
    ...
    \node[white] at (-1, -0.5) { $\mathsf{x}_{1 \setminus 2}$ };
    \node[white] at (0, 0) { $\mathsf{x}_{1} \cap \mathsf{x}_{2}$ };
    
    \node at (0, 2.5) { $\mathsf{x}_{1} = \mathsf{x}_{1 \setminus 2} 
                                           \cup (\mathsf{x}_{1} \cap \mathsf{x}_{2})$ };
  \end{scope}
  ...
  \begin{scope}[shift={(7, 0)}]
    ...
    \node[white] at (0.9, 0.75) { $\mathsf{x}_{2 \setminus 1}$ };
    \node[white] at (0, 0) { $\mathsf{x}_{1} \cap \mathsf{x}_{2}$ };
    
    \node at (0, 2.5) { $\mathsf{x}_{2} = (\mathsf{x}_{1} \cap \mathsf{x}_{2})
                                          \cup \mathsf{x}_{2 \setminus 1} $ };
  \end{scope}
