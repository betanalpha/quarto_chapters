...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \fill[white, opacity=0.75] (+1.75 * \d, -0.5 * \d) rectangle (-0.5 * \d, +3.5 * \d);
    \fill[white, opacity=0.75] (-0.5 * \d, 1.425 * \d) -- (-0.985 * \d, 2 * \d) -- (-0.5 * \d, 2 * \d) -- cycle;
    
    \node at (0, -0.85 * \d) { $p(y \mid \phi)$ };
