...
\begin{tikzpicture}[scale=1]
  ...
  \node[darkteal] at (0.75, 0.26) { $f^{-1}( \mathsf{y} ) \subset X$ };
  ...
  \begin{scope}
    ...
    \draw [darkteal, line width=1] (-3, -1.5) .. controls (-0.75, 1) and (1.5, -2) .. (3, 0.25);
  \end{scope}
  
  \node[darkteal] at (-0.2, -0.75) { $\mathsf{y} \subset Y$ };
