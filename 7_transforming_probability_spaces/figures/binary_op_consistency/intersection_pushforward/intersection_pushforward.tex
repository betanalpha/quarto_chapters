...
\begin{tikzpicture}[scale=1.0]
  ...
  \begin{scope}[shift=({0, 0})]
    ...
    \fill[domain=0:1, smooth, samples=100, variable=\t, darkteal, line width=1] 
  ...
  \begin{scope}[shift=({9, 0})]
    ...
    \begin{scope}
      ...
      \fill[domain=-128.1:128.25, smooth, samples=100, variable=\t, lightteal, line width=1] 
        plot ({phi(set2x(\t))}, {set2y(\t)}) -- cycle;
    \end{scope}
    \node[lightteal] at (1.5, -1.35) { $f_{*}(\mathsf{x}_{1}) \cap f_{*}(\mathsf{x}_{2})$ };
    ...
    \fill[domain=0:1, smooth, samples=10, variable=\t, darkteal, line width=1] 
      ...
      -- cycle;
    \node[darkteal] at (-0.25, 0) { $f_{*}(\mathsf{x}_{1} \cap \mathsf{x}_{2})$ };
  \end{scope}
