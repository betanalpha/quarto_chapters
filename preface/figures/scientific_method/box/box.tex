...
\begin{tikzpicture}[scale=1.0]
  ...
  \begin{scope}[shift={({\r * cos(-150) - 1.5}, {\r * sin(-150)})}]
    \pgfmathsetmacro{\dx}{2.2}
    \pgfmathsetmacro{\dy}{1.1}
    \pgfmathsetmacro{\r}{1.5}
    \pgfmathsetmacro{\dr}{0.35}
    \pgfmathsetmacro{\dt}{-10}
  
    \fill[rounded corners=3, fill=dark, text=white] 
      ({\r - 0.5 * \dx}, {0 - 0.5 * \dy}) rectangle +(\dx, \dy) 
    node [midway, align=center] {Quantify\\Inferences};
  
    \pgfmathsetmacro{\thetai}{120}
    \pgfmathsetmacro{\thetaf}{25}
  
    \fill[mid] (\thetai:{\r + \dr}) arc(\thetai:\thetaf:{\r + \dr}) -- 
               ({\r * cos(\thetaf + \dt)}, {\r * sin(\thetaf + \dt)}) --
               (\thetaf:{\r - \dr}) arc(\thetaf:\thetai:{\r - \dr})  -- cycle;
  
    \fill[rounded corners=3, fill=dark, text=white] 
      ({\r * cos(120) - 0.5 * \dx}, {\r * sin(120) - 0.5 * \dy}) rectangle +(\dx, \dy) 
    node [midway, align=center] {Critique\\Model};
  
    \pgfmathsetmacro{\thetai}{240}
    \pgfmathsetmacro{\thetaf}{155}
    ...
    \fill[rounded corners=3, fill=dark, text=white] 
      ({\r * cos(-120) - 0.5 * \dx}, {\r * sin(-120) - 0.5 * \dy}) rectangle +(\dx, \dy) 
    node [midway, align=center] {Develop\\Model};
      
    \begin{scope}
      \clip (2 * \r, -0.5 * \dy) rectangle +(-4 * \r, -1.5);
      \pgfmathsetmacro{\thetai}{0}
      \pgfmathsetmacro{\thetaf}{-80}
      \fill[mid] (\thetai:{\r + \dr}) arc(\thetai:\thetaf:{\r + \dr}) -- 
                 ({\r * cos(\thetaf + \dt)}, {\r * sin(\thetaf + \dt)}) --
                 (\thetaf:{\r - \dr}) arc(\thetaf:\thetai:{\r - \dr})  -- cycle;
    \end{scope}
