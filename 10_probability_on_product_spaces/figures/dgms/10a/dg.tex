...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \node (C) at (-1.75 * \d, +3 * \d) [unobscirc] { $x_{1}$ };
    ...
    %\node[anchor=west] at (3.25 * \d, 3.1 * \d) { $p( x_{1}, x_{2}, x_{3}, x_{2} )$ };    
    \node[anchor=west] at (3.25 * \d, 2.7 * \d) { $p( x_{1}, x_{2}, x_{3}, x_{4} )$ };
    \node[anchor=west] at (3.25 * \d, 2.3 * \d) { $\quad = \;\, p( x_{4} \mid x_{1}, x_{2} )$ }; 
    \node[anchor=west] at (3.25 * \d, 1.9 * \d) { $\quad\quad \cdot\, p( x_{1} \mid x_{3} )$ };
