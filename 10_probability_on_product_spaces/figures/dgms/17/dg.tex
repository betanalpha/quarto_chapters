...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \foreach \B/\E in {D/A, F/A, F/B, E/B, D/C, E/C} {
    ...
    \node[anchor=west] at (-1.5 * \d, -2.25 * \d) { $\quad\quad \cdot p ( x_{2} \mid x_{5}, x_{6} )$ };
    \node[anchor=west] at (-1.5 * \d, -2.75 * \d) { $\quad\quad \cdot p ( x_{3} \mid x_{4}, x_{5} )$ };
