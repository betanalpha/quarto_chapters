...
\NormalTok{format\_string }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(}\StringTok{"Posterior probability that entrant \%i \textgreater{} "}\NormalTok{,}
                        \StringTok{"entrant \%i skill = \%.3f +/{-} \%.3f."}\NormalTok{)}
