...
# probability density function.  Markov chain Monte Carlo estimates the
# output bin probabilities from the input samples, with the bin probability
# estimator errors visualized in the border color.
# @param samples A two-dimensional array of expectand values with the 
#                first dimension indexing the Markov chains and the 
#                second dimension indexing the sequential states within 
#                each Markov chain.
...
# @param col Color for plotting weighted bin probabilities; defaults to c_dark
# @param border Color for plotting estimator error; defaults to gray
# @param add Configure plot to overlay over existing plot; defaults to FALSE
