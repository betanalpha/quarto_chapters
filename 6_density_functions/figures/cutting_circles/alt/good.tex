...
\tikzmath{
  ...
  function unrolledvonmises(\y, \to, \m, \k, \logI) {
    \x = logistic(\y);
    return vonmises(\to + 360 * \x, \m, \k, \logI) * \x * (1 - \x);
  };
...
\begin{tikzpicture}[scale=1.0]
  ...
  \pgfmathsetmacro{\kappa}{100}
  \pgfmathsetmacro{\logI}{96.77973}
  
  \pgfmathsetmacro{\theta}{0}
  \pgfmathsetmacro{\phi}{60}

  \begin{scope}[shift={(0, 0)}]
    %\draw[white] (-3.5, -2.5) rectangle (3.5, 2.25);
