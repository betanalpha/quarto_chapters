...
\begin{tikzpicture}[scale=1.0]
  ...
  \begin{scope}[shift={(5.25, -3)}]
    ...
    \fill[mid] (0, -1.5) rectangle (1, -0.25);
    
    \node[dark] at (0, -2.5) { $\mathsf{x}_{1} \times \mathsf{x}_{2} = (\mathsf{x}_{1} \times X_{2}) \cap (X_{1} \times\mathsf{x}_{2})$ };
  \end{scope}

  \begin{scope}[shift={(11, -3)}]
    \draw[white] (-2.75, -2.75) rectangle (2.75, 2.25);
    
    \fill[mid] (-2, -2) rectangle (2, 2);
    
    \fill[light] (0, -1.5) rectangle (1, -0.25);
    
    \node[dark] at (0, -2.5) { $(\mathsf{x}_{1} \times \mathsf{x}_{2})^{c}$ };
  \end{scope}
