...
\begin{tikzpicture}[scale=0.8]
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \foreach \n in {2, 3, 4} {
      ...
      \colorlet{custom}{darkteal!\prop!light}; 
      \draw[custom, dashed, line width=1] (-0.5, 0) circle (\r); 
    }
    
    \foreach \x in {-1.5, -0.5, +0.5} {
      \foreach \y in {-1, 0, +1} {
        \fill[darkteal] (\x, \y) circle (0.05);
      }
    }
  
    \fill[darkteal] (-0.5, 0) circle (0.05) node[below] { $x$ };
  \end{scope} 
  ...
  \begin{scope}[shift={(7, 0)}]
    ...
    \fill[darkteal] (-0.5, +1) circle (0.05);
    \fill[darkteal] (-0.5, -1) circle (0.05);
    \fill[darkteal] (-1.5, 0) circle (0.05);
    \fill[darkteal] (+0.5, 0) circle (0.05);
