...
\begin{tikzpicture}[scale=0.95]
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \filldraw[darkteal, dashed, line width=1] (0, 0) circle(\eps);
    \node[darkteal] at (1.8, -1.7) { $\mathsf{b}_{\epsilon_{1}}(x)$ };
    ...
    \fill[white] (0, 0) circle (0.05) node[right] { $x$ };
  \end{scope}
  ...
  \begin{scope}[shift={(7, 0)}]
    ...
    \draw[gray90, dashed, line width=1] (0, 0) circle(1.95);  
    \filldraw[darkteal, dashed, line width=1] (0, 0) circle(\eps);
    \node[darkteal] at (1.4, -0.95) { $\mathsf{b}_{\epsilon_{2}}(x)$ };
  ...
  \begin{scope}[shift={(14, 0)}]
    ...
    \draw[gray90, dashed, line width=1] (0, 0) circle(1.95);  
    \draw[gray90, dashed, line width=1] (0, 0) circle(1.15);  
    \filldraw[darkteal, dashed, line width=1] (0, 0) circle(\eps);
    \node[darkteal] at (0.5, 0.7) { $\mathsf{b}_{\epsilon_{3}}(x)$ };
