...
\begin{tikzpicture}[scale=1, thick]
  ...
  \foreach \x/\y/\p/\glyph [count=\n] in {0/0/0.15/\Box, -2/-0.75/0.05/\clubsuit, 
    ...
    \begin{scope}[shift={(\x, \y)}]
      ...
      \node[white] at (0, {4 * \p}) { $\scriptstyle m_{\glyph} / M$ };
    \end{scope}
  }
  
  \node[dark] at (0, -2.25) { $  \frac{m_\Box}{M} + \frac{m_\clubsuit}{M} + \frac{m_\diamondsuit}{M} 
                               + \frac{m_\heartsuit}{M} + \frac{m_\spadesuit}{M} = \frac{M}{M} = 1$ };
