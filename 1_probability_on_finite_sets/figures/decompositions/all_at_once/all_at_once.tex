...
\begin{tikzpicture}[scale=1, thick]
  ...
  \draw[white] (-2, -3.5) rectangle (7, 3.5);
  ...
  \foreach \p/\glyph [count=\n] in {0.15/\spadesuit, 0.23/\heartsuit, 0.25/\diamondsuit, 0.17/\clubsuit, 0.2/\Box} {
  ...
  \node[dark, anchor=west] at (0.6, -0.15) { $\mu(X)$ };
