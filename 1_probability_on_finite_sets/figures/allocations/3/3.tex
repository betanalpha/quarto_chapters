...
\begin{tikzpicture}[scale=1, thick]
  ...
  \foreach \x/\y/\p/\glyph [count=\n] in {0/0/0.15/\Box, -2/-0.75/0.05/\clubsuit, 2/1/0.3/\diamondsuit} {
    \begin{scope}[shift={(\x, \y)}]
  ...
  \begin{scope}[shift={(-4, -1.5)}]
    ...
    \drawcube{\dx}{\dy}{4 * (1 - 0.5)}{\tilt}
    \drawcubecagefront{\dx}{\dy}{4}{\tilt}
  \end{scope}
  
  \node[dark, anchor=west] at (-4.25, -2.25) { $M - m_\Box - m_\clubsuit - m_\diamondsuit$ };
