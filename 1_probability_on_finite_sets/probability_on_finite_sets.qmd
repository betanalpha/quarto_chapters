---
title: "Probability Theory on Finite Sets"
...
Regardless of how many elements a finite set $X$ contains three special
...
In other words the collection of all subsets is itself a finite set with
...
like the real line.  This will be the topic of Chapter 4.
...
available on [GitHub](
https://github.com/betanalpha/quarto_chapters/tree/main/probability_on_finite_sets).
