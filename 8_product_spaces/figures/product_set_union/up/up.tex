...
\begin{tikzpicture}[scale=1.0]
  ...
  \begin{scope}[shift={(0, -6)}]
    ...
    \fill[mid] (-1, -2) rectangle (1, 2);
    
    \node[dark] at (0, -2.5) { $(\mathsf{x}_{1} \cup \mathsf{x}_{1}') \times X_{2}$ };
  \end{scope}
  ...
  \begin{scope}[shift={(11, -6)}]
    ...
    \fill[mid] (-2, -1.5) rectangle (2, 1.5);
    
    \node[dark] at (0, -2.5) { $X_{1} \times (\mathsf{x}_{2} \cup \mathsf{x}_{2}')$ };
  \end{scope}
  ...
  \begin{scope}[shift={(5.5, -11.5)}]
    ...
    \fill[mid] (-1, -2) rectangle (1, 2);
    \fill[mid] (-2, -1.5) rectangle (2, 1.5);
    \fill[dark] (-1, -1.5) rectangle (1, 1.5);
    \draw[dark, dashed] (-1, -1.5) rectangle (1, 1.5);
    
    \node[dark] at (0, -2.5) { $(\mathsf{x}_{1} \cup \mathsf{x}_{1}') \times (\mathsf{x}_{2} \cup \mathsf{x}_{2}') = \big( (\mathsf{x}_{1} \cup \mathsf{x}_{1}') \times X_{2} \big) \cap \big( X_{1} \times (\mathsf{x}_{2} \cup \mathsf{x}_{2}') \big)$ };
  \end{scope}
