...
\begin{tikzpicture}[scale=1]
  ...
  \node at (0, 2.5) { $\iota: [0, 1] \rightarrow \mathbb{R}$ };

  \foreach [count=\n] \y in {0, 0.15, 0.3} {
    \draw[gray90, ->, >=stealth, line width=1] (-3, \y) -- (2.8, \y);
  }
  
  \draw[line width=1] (-3, 0) -- (-3, 0.3);
  \draw[line width=1] (-2.8, 0) -- (-3.2, 0);
  \draw[line width=1] (-2.8, 0.3) -- (-3.2, 0.3);
  \node at (-3, -2.25) { $[0, 1] \subset \mathbb{R}$ };
