...
\begin{scope}[shift={(0, 0)}]
  ...
  \foreach \yr in {2, 2.3, ..., 3.5} {
    ...
    \draw[lightteal, line width=1.5] (0, \yr) 
      arc[start angle=90, end angle={180 - \theta}, x radius=\xr, y radius=\yr];
    \draw[lightteal, line width=1.5, ->, >=stealth] (0, \yr) 
  ...
  \fill[white] (-0.55, -2 + 0.3) rectangle (0.55, -3.5);
  \node at (0, -1.9) { $\mathbb{I}_{\mu}[f_{1}]$ };
  \node at (0, -2.3) { $\cdots$ };
  \node at (0, -2.7) { $\mathbb{I}_{\mu}[f_{j}]$ };
  \node at (0, -3.1) { $\cdots$ };
  \node at (0, -3.5) { $\mathbb{I}_{\mu}[f_{J}]$ };
  \node at (0, -3.9) { Answers };
\end{scope}
