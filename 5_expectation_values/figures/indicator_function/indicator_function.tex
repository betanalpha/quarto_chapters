...
\begin{tikzpicture}[scale=1.0]
  ...
  \draw[midteal, line width = 1.25] (-3, -2) -- (0.5, -2);
  \draw[midteal, line width = 1.25] (0.5, +2) -- (2, 2);
  \draw[midteal, line width = 1.25] (2, -2) -- (2.85, -2);
  
  \draw[gray50, line width=1, decorate,decoration={brace,amplitude=5pt,mirror}] (0.5, -2.1) -- (2, -2.1);
  \node[gray50] at (1.25, -2.5) { $\mathsf{x}$ };
  
  \node at (-3.35, -2) { $0$ };
  \node at (-3.35, +2) { $1$ };
  \node at (-4, 0) { $I_{\mathsf{x}}(x)$ };
