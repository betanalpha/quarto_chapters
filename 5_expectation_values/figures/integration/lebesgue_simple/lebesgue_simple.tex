...
\begin{tikzpicture}[scale=1.0]
  ...
  \node[dark] at (-0.25, -1.25) { $\mathbb{I}_{\lambda} [ \phi_{1} \cdot I_{[x_{1, 1}, x_{2, 1}]} ]$ }; 
  
  \filldraw[fill=light, draw=mid] (-2, -0.5) rectangle (1.75, 0.5);
  \node[dark] at (-0.125, 0) { $\mathbb{I}_{\lambda} [ \phi_{2} \cdot I_{[x_{1, 2}, x_{2, 2}]} ]$ }; 

  \filldraw[fill=light, draw=mid] (-1.75, 0.5) rectangle (1, 1.5);
  \node[dark] at (-0.375, 1) { $\mathbb{I}_{\lambda} [ \phi_{3} \cdot I_{[x_{1, 3}, x_{2, 3}]} ]$ }; 
