...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, enhanced, frame hidden, borderline west={3pt}{0pt}{shadecolor}, breakable, boxrule=0pt, interior hidden]}{\end{tcolorbox}}\fi
...
Four} we defined measures, and probability distributions as a special
...
numbers that generalizes Riemann integration from calculus. This
measure-informed integration operation summarizes the interaction
between a measure and a given function, allowing us to use one to learn
about the other.
...
\hypertarget{sec:finite_integration}{%
...
\includegraphics{figures/probing_functions/probing_functions.pdf}
...
\includegraphics{figures/probing_measures/probing_measures.pdf}
...
\includegraphics{figures/embeddings/identity/identity.pdf}
...
\includegraphics{figures/embeddings/interval/interval.pdf}
...
\includegraphics{figures/embeddings/integer/integer.pdf}
...
\includegraphics{figures/histograms/varying_behaviors/diffuse/diffuse.pdf}
...
\includegraphics{figures/histograms/varying_behaviors/unimodal/unimodal.pdf}
...
\includegraphics{figures/histograms/varying_behaviors/unimodal_skewed/unimodal_skewed.pdf}
...
\includegraphics{figures/cdfs/cdf_behaviors/unimodal/unimodal.pdf}
...
\includegraphics{figures/cdfs/cdf_behaviors/narrow_unimodal/narrow_unimodal.pdf}
...
\includegraphics{figures/cdfs/cdf_behaviors/gap/gap.pdf}
...
\includegraphics{figures/integration/lebesgue_indicator/lebesgue_indicator.pdf}
...
\includegraphics{figures/integration/lebesgue_simple/lebesgue_simple.pdf}
...
\includegraphics{figures/integration/lebesgue/lebesgue.pdf}
...
\includegraphics{figures/integration/riemann/riemann.pdf}
