...
\begin{tikzpicture}[scale=1, thick]
  ...
  \node[dark, anchor=west] at (\Dx + 0.6, 1.1) { $\mu( \{ x_1, x_2, x_3\})$ };
  \node[dark, anchor=west] at (\Dx + 0.6, -1.9) { $\mu( \{ x_4, x_5 \})$ };

  \node[dark, anchor=west] at (2 * \Dx + 0.6, 1.9) { $\mu( \{ x_1, x_2\})$ };
  \node[dark, anchor=west] at (2 * \Dx + 0.6, 0.1) { $\mu( \{ x_3 \})$ };
  \node[dark, anchor=west] at (2 * \Dx + 0.6, -1.4) { $\mu( \{ x_4 \})$ };
  \node[dark, anchor=west] at (2 * \Dx + 0.6, -2.65) { $\mu( \{ x_5 \})$ };

  \node[dark, anchor=west] at (3 * \Dx + 0.6, 2.25) { $\mu( \{ x_1 \})$ };
  \node[dark, anchor=west] at (3 * \Dx + 0.6, 1.2) { $\mu( \{ x_2 \})$ };
  \node[dark, anchor=west] at (3 * \Dx + 0.6, 0.1) { $\mu( \{ x_3 \})$ };
  \node[dark, anchor=west] at (3 * \Dx + 0.6, -1.4) { $\mu( \{ x_4 \})$ };
  \node[dark, anchor=west] at (3 * \Dx + 0.6, -2.65) { $\mu( \{ x_5 \})$ };
