...
\begin{tikzpicture}[scale=1, thick]
  ...
  \node[black, opacity=0.25] at (-4, 0.5 * 0.75) { $\mathsf{x}_1 = \{x_1, x_4 \}$ };
  \node[black, opacity=0.25] at (4, -0.5) { $\mathsf{x}_2 = \{x_1, x_5 \}$ };
  
  \node[black] at (0, 3) { $\mathsf{x}_1 \cup \mathsf{x}_2 = \{x_1, x_4, x_5 \}$ };
  \node[black] at (0, -2) { $\mathsf{x}_1 \cap \mathsf{x}_2 = \{ x_1 \}$ };
